...
public class TipsAdapter extends RecyclerView.Adapter<TipsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.tips_img_iv.setImageResource(items.get(position).tips_img);
        holder.tips_title_tv.setText(items.get(position).tips_title);
        holder.tips_descriptions_tv.setText(items.get(position).tips_descriptions);
    }
